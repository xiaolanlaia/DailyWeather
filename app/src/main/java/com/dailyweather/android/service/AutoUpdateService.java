...
public class AutoUpdateService extends Service {
    ...
    public int onStartCommand(Intent intent,int flags,int startId){
        ...
        int anHour = 8 * 60 * 60 *1000; //This is 8 hours of milliseconds;
    ...
    private void updateWeather(){
        ...
        if (weatherString != null){
            //Directly parsing the weather data when there is cashing;
    ...
    /**
     * Update the daily picture;
     */
    private void updateBingPic(){
        String requestBingPic = "http://guolin.tech/api/bing_ic";
